      ...
      <div className="bg-gradient-to-r from-blue-600 to-teal-600 text-white py-24">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold mb-6">RID-CRC GOV™</h1>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-8">
                We're currently developing comprehensive resources for institutional partners. 
                Check back soon for updates on our government engagement initiatives.
              </p>
