          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="hover:shadow-lg transition duration-300 border-t-4 border-teal-600">
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <Link to="/find-a-gp">
                  <Button variant="secondary" className="w-full text-lg">Get Screened - GP</Button>
                </Link>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition duration-300 border-t-4 border-amber-600">
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <Link to="/find-a-specialist">
                  <Button variant="secondary" className="w-full text-lg">Get Screened - Specialist</Button>
                </Link>
              </CardContent>
            </Card>
