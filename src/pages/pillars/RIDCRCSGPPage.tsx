      ...
      <div className="bg-gradient-to-r from-blue-600 to-teal-600 text-white py-24">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold mb-6">RID-CRC SGP™</h1>
            <p className="text-xl mb-0">
              Clinician Activation (Specialists and GPs)
            </p>
          </div>
        </Container>
      </div>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-8">
                We're currently developing comprehensive resources for healthcare professionals. 
                Check back soon for updates on our clinician engagement programs.
              </p>
